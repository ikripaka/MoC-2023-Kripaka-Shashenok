...
pub fn run(filepath: &str) {
    ...
    println!("Frequency tables are calculated (criterion_5_1)");
    ...
    println!("N grams are made (criterion_5_1)");
    ...
    for l_little in 1..=2 {
        ...
        println!("Distorted N grams are made (criterion_5_1)");

        let j_empty_1 = 0;
        let j_empty_bigram_1 = 50;
        let k_empty_1 = j_empty_bigram_1 - 5;
        let j_empty_2 = 0;
        let j_empty_bigram_2 = 50;
        let k_empty_2 = j_empty_bigram_2 - 10;
        let j_empty_3 = 0;
        let j_empty_bigram_3 = 100;
        let k_empty_3 = j_empty_bigram_3 - 60;
        let j_empty_4 = 0;
        let j_empty_bigram_4 = 200;
        let k_empty_4 = j_empty_bigram_4 - 199;

        let sorted_map_bigram = sort_hash_map(&freq_table_bigram);
        let sorted_map_l1 = sort_hash_map(&freq_table_l1);
        // let sorted_map_l2 =  sort_hash_map(&freq_table_l2);
        // let sorted_map_l3 =  sort_hash_map(&freq_table_l3);
        // let sorted_map_l4 =  sort_hash_map(&freq_table_l4);


        rayon::scope(|s| {
            s.spawn(|_s| {
                res1_0 = criterion_5_1(&sorted_map_l1, &sorted_map_bigram, &n_gram_l1, j_empty_1, j_empty_bigram_1, k_empty_1);
            });
            s.spawn(|_s| {
                let time_prev_local = Local::now();
                res1_1_r1 = criterion_5_1(&sorted_map_l1, &sorted_map_bigram, &distorted_n_grams_l1_1_r1.0,  j_empty_1, j_empty_bigram_1, k_empty_1);
                println!(
            ...
            s.spawn(|_s| {
                let time_prev_local = Local::now();
                res1_1_r2 = criterion_5_1(&sorted_map_l1, &sorted_map_bigram, &distorted_n_grams_l1_1_r2.0,  j_empty_1, j_empty_bigram_1, k_empty_1);
                println!(
            ...
            s.spawn(|_s| {
                let time_prev_local = Local::now();
                res1_1_r3 = criterion_5_1(&sorted_map_l1, &sorted_map_bigram, &distorted_n_grams_l1_1_r3.0,  j_empty_1, j_empty_bigram_1, k_empty_1);
                println!(
            ...
            s.spawn(|_s| {
                let time_prev_local = Local::now();
                res1_2 = criterion_5_1(&sorted_map_l1, &sorted_map_bigram, &distorted_n_grams_l1_2.0,  j_empty_1, j_empty_bigram_1, k_empty_1);
                println!(
            ...
            s.spawn(|_s| {
                let time_prev_local = Local::now();
                res1_3 = criterion_5_1(&sorted_map_l1, &sorted_map_bigram, &distorted_n_grams_l1_3,  j_empty_1, j_empty_bigram_1, k_empty_1);
                println!(
            ...
            s.spawn(|_s| {
                let time_prev_local = Local::now();
                res1_4 = criterion_5_1(&sorted_map_l1, &sorted_map_bigram, &distorted_n_grams_l1_4,  j_empty_1, j_empty_bigram_1, k_empty_1);
                println!(
            ...
            s.spawn(|_s| {
                let time_prev_local = Local::now();
                res2_0 = criterion_5_1(&sorted_map_l1, &sorted_map_bigram, &n_gram_l2, j_empty_2, j_empty_bigram_2, k_empty_2);
                println!(
            ...
            s.spawn(|_s| {
                let time_prev_local = Local::now();
                res2_1_r1 = criterion_5_1(&sorted_map_l1, &sorted_map_bigram, &distorted_n_grams_l2_1_r1.0, j_empty_2, j_empty_bigram_2, k_empty_2);
                println!(
            ...
            s.spawn(|_s| {
                let time_prev_local = Local::now();
                res2_1_r2 = criterion_5_1(&sorted_map_l1, &sorted_map_bigram, &distorted_n_grams_l2_1_r2.0,j_empty_2, j_empty_bigram_2, k_empty_2);
                println!(
            ...
            s.spawn(|_s| {
                let time_prev_local = Local::now();
                res2_1_r3 = criterion_5_1(&sorted_map_l1, &sorted_map_bigram, &distorted_n_grams_l2_1_r3.0, j_empty_2, j_empty_bigram_2, k_empty_2);
                println!(
            ...
            s.spawn(|_s| {
                let time_prev_local = Local::now();
                res2_2 = criterion_5_1(&sorted_map_l1, &sorted_map_bigram, &distorted_n_grams_l2_2.0, j_empty_2, j_empty_bigram_2, k_empty_2);
                println!(
            ...
            s.spawn(|_s| {
                let time_prev_local = Local::now();
                res2_3 = criterion_5_1(&sorted_map_l1, &sorted_map_bigram, &distorted_n_grams_l2_3, j_empty_2, j_empty_bigram_2, k_empty_2);
                println!(
            ...
            s.spawn(|_s| {
                let time_prev_local = Local::now();
                res2_4 = criterion_5_1(&sorted_map_l1, &sorted_map_bigram, &distorted_n_grams_l2_4, j_empty_2, j_empty_bigram_2, k_empty_2);
                println!(
            ...
            s.spawn(|_s| {
                let time_prev_local = Local::now();
                res3_0 = criterion_5_1(&sorted_map_l1, &sorted_map_bigram, &n_gram_l3, j_empty_3, j_empty_bigram_3, k_empty_3);
                println!(
            ...
            s.spawn(|_s| {
                let time_prev_local = Local::now();
                res3_1_r1 = criterion_5_1(&sorted_map_l1, &sorted_map_bigram, &distorted_n_grams_l3_1_r1.0, j_empty_3, j_empty_bigram_3, k_empty_3);
                println!(
            ...
            s.spawn(|_s| {
                let time_prev_local = Local::now();
                res3_1_r2 = criterion_5_1(&sorted_map_l1, &sorted_map_bigram, &distorted_n_grams_l3_1_r2.0, j_empty_3, j_empty_bigram_3, k_empty_3);
                println!(
            ...
            s.spawn(|_s| {
                let time_prev_local = Local::now();
                res3_1_r3 = criterion_5_1(&sorted_map_l1, &sorted_map_bigram, &distorted_n_grams_l3_1_r3.0, j_empty_3, j_empty_bigram_3, k_empty_3);
                println!(
            ...
            s.spawn(|_s| {
                let time_prev_local = Local::now();
                res3_2 = criterion_5_1(&sorted_map_l1, &sorted_map_bigram, &distorted_n_grams_l3_2.0, j_empty_3, j_empty_bigram_3, k_empty_3);
                println!(
            ...
            s.spawn(|_s| {
                let time_prev_local = Local::now();
                res3_3 = criterion_5_1(&sorted_map_l1, &sorted_map_bigram, &distorted_n_grams_l3_3, j_empty_3, j_empty_bigram_3, k_empty_3);
                println!(
            ...
            s.spawn(|_s| {
                let time_prev_local = Local::now();
                res3_4 = criterion_5_1(&sorted_map_l1, &sorted_map_bigram, &distorted_n_grams_l3_4, j_empty_3, j_empty_bigram_3, k_empty_3);
                println!(
            ...
            s.spawn(|_s| {
                let time_prev_local = Local::now();
                res4_0 = criterion_5_1(&sorted_map_l1, &sorted_map_bigram, &n_gram_l4, j_empty_4, j_empty_bigram_4, k_empty_4);
                println!(
            ...
            s.spawn(|_s| {
                let time_prev_local = Local::now();
                res4_1_r1 = criterion_5_1(&sorted_map_l1, &sorted_map_bigram, &distorted_n_grams_l4_1_r1.0, j_empty_4, j_empty_bigram_4, k_empty_4);
                println!(
            ...
            s.spawn(|_s| {
                let time_prev_local = Local::now();
                res4_1_r2 = criterion_5_1(&sorted_map_l1, &sorted_map_bigram, &distorted_n_grams_l4_1_r2.0, j_empty_4, j_empty_bigram_4, k_empty_4);
                println!(
            ...
            s.spawn(|_s| {
                let time_prev_local = Local::now();
                res4_1_r3 = criterion_5_1(&sorted_map_l1, &sorted_map_bigram, &distorted_n_grams_l4_1_r3.0, j_empty_4, j_empty_bigram_4, k_empty_4);
                println!(
            ...
            s.spawn(|_s| {
                let time_prev_local = Local::now();
                res4_2 = criterion_5_1(&sorted_map_l1, &sorted_map_bigram, &distorted_n_grams_l4_2.0, j_empty_4, j_empty_bigram_4, k_empty_4);
                println!(
            ...
            s.spawn(|_s| {
                let time_prev_local = Local::now();
                res4_3 = criterion_5_1(&sorted_map_l1, &sorted_map_bigram, &distorted_n_grams_l4_3, j_empty_4, j_empty_bigram_4, k_empty_4);
                println!(
            ...
            s.spawn(|_s| {
                let time_prev_local = Local::now();
                res4_4 = criterion_5_1(&sorted_map_l1, &sorted_map_bigram, &distorted_n_grams_l4_4, j_empty_4, j_empty_bigram_4, k_empty_4);
                println!(
        ...
        \n\t (criterion_5_1) [l: {l_little}] [res1_0](h0, h1): {:?}, ((p_h_0, p_h_1), (alpha, beta)): {:?} \
        \n\t (criterion_5_1) [l: {l_little}] [res_1_r1](h0, h1): {:?}, ((p_h_0, p_h_1), (alpha, beta)): {:?}\
        \n\t (criterion_5_1) [l: {l_little}] [res_1_r2](h0, h1): {:?}, ((p_h_0, p_h_1), (alpha, beta)): {:?}\
        \n\t (criterion_5_1) [l: {l_little}] [res_1_r3](h0, h1): {:?}, ((p_h_0, p_h_1), (alpha, beta)): {:?}\
        \n\t (criterion_5_1) [l: {l_little}] [res_1_2](h0, h1): {:?}, ((p_h_0, p_h_1), (alpha, beta)): {:?} ,\
        \n\t (criterion_5_1) [l: {l_little}] [res_1_3](h0, h1): {:?}, ((p_h_0, p_h_1), (alpha, beta)): {:?} \
        \n\t (criterion_5_1) [l: {l_little}] [res_1_4](h0, h1): {:?}, ((p_h_0, p_h_1), (alpha, beta)): {:?} \

        \n\t (criterion_5_1) [l: {l_little}] [res_2_0](h0, h1): {:?}, ((p_h_0, p_h_1), (alpha, beta)): {:?}\
        \n\t (criterion_5_1) [l: {l_little}] [res_2_r1](h0, h1): {:?}, ((p_h_0, p_h_1), (alpha, beta)): {:?}\
        \n\t (criterion_5_1) [l: {l_little}] [res_2_r2](h0, h1): {:?}, ((p_h_0, p_h_1), (alpha, beta)): {:?}\
        \n\t (criterion_5_1) [l: {l_little}] [res_2_r3](h0, h1): {:?}, ((p_h_0, p_h_1), (alpha, beta)): {:?}\
        \n\t (criterion_5_1) [l: {l_little}] [res_2_2](h0, h1): {:?}, ((p_h_0, p_h_1), (alpha, beta)): {:?}\
        \n\t (criterion_5_1) [l: {l_little}] [res_2_3](h0, h1): {:?}, ((p_h_0, p_h_1), (alpha, beta)): {:?}\
        \n\t (criterion_5_1) [l: {l_little}] [res_2_4](h0, h1): {:?}, ((p_h_0, p_h_1), (alpha, beta)): {:?}\

        \n\t (criterion_5_1) [l: {l_little}] [res_3_0](h0, h1): {:?}, ((p_h_0, p_h_1), (alpha, beta)): {:?}\
        \n\t (criterion_5_1) [l: {l_little}] [res_3_r1](h0, h1): {:?}, ((p_h_0, p_h_1), (alpha, beta)): {:?}\
        \n\t (criterion_5_1) [l: {l_little}] [res_3_r2](h0, h1): {:?}, ((p_h_0, p_h_1), (alpha, beta)): {:?}\
        \n\t (criterion_5_1) [l: {l_little}] [res_3_r3](h0, h1): {:?}, ((p_h_0, p_h_1), (alpha, beta)): {:?}\
        \n\t (criterion_5_1) [l: {l_little}] [res_3_2](h0, h1): {:?}, ((p_h_0, p_h_1), (alpha, beta)): {:?}\
        \n\t (criterion_5_1) [l: {l_little}] [res_3_3](h0, h1): {:?}, ((p_h_0, p_h_1), (alpha, beta)): {:?}\
        \n\t (criterion_5_1) [l: {l_little}] [res_3_4](h0, h1): {:?}, ((p_h_0, p_h_1), (alpha, beta)): {:?}\

        \n\t (criterion_5_1) [l: {l_little}] [res_4_0](h0, h1): {:?}, ((p_h_0, p_h_1), (alpha, beta)): {:?}\
        \n\t (criterion_5_1) [l: {l_little}] [res_4_r1](h0, h1): {:?}, ((p_h_0, p_h_1), (alpha, beta)): {:?}\
        \n\t (criterion_5_1) [l: {l_little}] [res_4_r2](h0, h1): {:?}, ((p_h_0, p_h_1), (alpha, beta)): {:?}\
        \n\t (criterion_5_1) [l: {l_little}] [res_4_r3](h0, h1): {:?}, ((p_h_0, p_h_1), (alpha, beta)): {:?}\
        \n\t (criterion_5_1) [l: {l_little}] [res_4_2](h0, h1): {:?}, ((p_h_0, p_h_1), (alpha, beta)): {:?}\
        \n\t (criterion_5_1) [l: {l_little}] [res_4_3](h0, h1): {:?}, ((p_h_0, p_h_1), (alpha, beta)): {:?}\
        \n\t (criterion_5_1) [l: {l_little}] [res_4_4](h0, h1): {:?}, ((p_h_0, p_h_1), (alpha, beta)): {:?}\
...
fn criterion_5_1(
    sorted_map_l_gram: &Vec<(String, u64)>,
    sorted_map_bigram: &Vec<(String, u64)>,
    l_grams: &Vec<String>,
    j: usize,
    j_bigram: usize,
    k_empty: usize,
    ...
    let mut l_grams_b_prh = sorted_map_l_gram.clone();
    let mut bigrams_b_prh = sorted_map_bigram.clone();
