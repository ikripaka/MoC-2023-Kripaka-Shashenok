use crate::internals::{
    generate_affine_distortion, generate_random_n_l_grams,
    is_n_gram_prohibited_with_custom_l_grams, make_frequency_table, make_frequency_table_from_file,
    make_n_gram_on_content_from_str, recurrent_generation_n_l_grams, vigenere_cipher_distortion,
};
...
pub fn run(filepath: &str) {
    ...
    println!(
        "Result: \
        \n\t (criterion_1) res_1_0: {:?} \
        \n\t (criterion_1) res_1_r1: {:?}\
        \n\t (criterion_1) res_1_r2: {:?}\
        \n\t (criterion_1) res_1_r3: {:?}\
        \n\t (criterion_1) res_1_2: {:?}\
        \n\t (criterion_1) res_1_3: {:?}\
        \n\t (criterion_1) res_1_4: {:?}\

        \n\t (criterion_1) res_2_0: {:?}\
        \n\t (criterion_1) res_2_r1: {:?}\
        \n\t (criterion_1) res_2_r2: {:?}\
        \n\t (criterion_1) res_2_r3: {:?}\
        \n\t (criterion_1) res_2_2: {:?}\
        \n\t (criterion_1) res_2_3: {:?}\
        \n\t (criterion_1) res_2_4: {:?}\

        \n\t (criterion_1) res_3_0: {:?}\
        \n\t (criterion_1) res_3_r1: {:?}\
        \n\t (criterion_1) res_3_r2: {:?}\
        \n\t (criterion_1) res_3_r3: {:?}\
        \n\t (criterion_1) res_3_2: {:?}\
        \n\t (criterion_1) res_3_3: {:?}\
        \n\t (criterion_1) res_3_4: {:?}\

        \n\t (criterion_1) res_4_0: {:?}\
        \n\t (criterion_1) res_4_r1: {:?}\
        \n\t (criterion_1) res_4_r2: {:?}\
        \n\t (criterion_1) res_4_r3: {:?}\
        \n\t (criterion_1) res_4_2: {:?}\
        \n\t (criterion_1) res_4_3: {:?}\
        \n\t (criterion_1) res_4_4: {:?}\
...
fn criterion_1(
    ...
    for l_gram in l_grams {
        ...
        rayon::scope(|s| {
            ...
            s.spawn(|_s| {
                has_prohibited_l_gram = is_n_gram_prohibited_with_custom_l_grams(
                    l_gram,
                    freq_table_prh[2],
                    threshold,
                    l_grams_len[2],
